    ...
    <div className="space-y-8">
      ...
      <div className="space-y-2">
        <div className="w-full bg-muted rounded-full h-2">
          <div className="bg-primary w-2/4 h-2 rounded-full" />
        </div>
      ...
      <div className="space-y-6">
        <div className="text-center space-y-2">
          ...
          <p className="text-muted-foreground">
            Help us understand your social media needs better
          </p>
        </div>
        ...
        <Card className="p-6 space-y-6">
          <div className="space-y-4">
            <div className="space-y-2">
              <Label>How often do you post on social media?</Label>
              <Select>
                <SelectTrigger>
            ...
            <div className="space-y-2">
              <Label>Which platforms do you use most?</Label>
            ...
            <div className="space-y-2">
              <Label>Would you like post reminders?</Label>
              <div className="grid grid-cols-2 gap-4">
                <Button variant="outline">Yes, remind me</Button>
